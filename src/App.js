...
const homeTouchdown = element => {
  setHomeScore (home + 7);
};
const homeFieldGoal = element => {
  setHomeScore(home + 3);
};

const awayTouchdown = element => {
  setAwayScore (away + 7);
};

const awayFieldGoal = element => {
  setAwayScore (away + 3);
};
...
<div className="home__score">{home}</div>
  ...
  <div className="timer">00:03</div> {/*timer change? do set timeout if so[I wrote this]*/}
          <div className="away">
